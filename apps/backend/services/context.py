...
class ServiceContextGenerator:
    ...
    def _load_project_index(self) -> dict:
        """Load project index from file (.ouro is the current location, .auto-claude for backwards compatibility)."""
        # Check .ouro first
        ...
        if legacy_index_file.exists():
            with open(legacy_index_file) as f:
                return json.load(f)
    ...
    def generate_markdown(self, context: ServiceContext) -> str:
        ...
        lines.extend(
            [
                ...
                "---",
                "",
                "*This file was auto-generated by the Ouro framework.*",
