...
class RoadmapOrchestrator:
    ...
    def __init__(
        ...
        # Default output to project's .ouro directory (installed instance)
        # Note: auto-claude/ is source code, .ouro/ is the installed instance
        if output_dir:
            self.output_dir = Path(output_dir)
        else:
            # Initialize .ouro directory and ensure it's in .gitignore
            init_auto_claude_dir(self.project_dir)
            self.output_dir = self.project_dir / ".ouro" / "roadmap"
