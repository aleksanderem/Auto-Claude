...
class GitHubOrchestrator:
    ...
    def __init__(
        ...
        # GitHub directory for storing state (prefer .ouro, fallback to .auto-claude)
        self.github_dir = self.project_dir / ".ouro" / "github"
        legacy_github_dir = self.project_dir / ".auto-claude" / "github"
        if not self.github_dir.exists() and legacy_github_dir.exists():
            self.github_dir = legacy_github_dir
    ...
    def _generate_enhanced_summary(
        ...
        lines.append("---")
        lines.append("_Generated by Ouro PR Review_")
