...
Shows how Ouro automatically generates provider-specific database names
...
def test_provider_naming():
    ...
    for provider, model, dim in providers:
        ...
        db_name = config.get_provider_specific_database_name("ouro_memory")
        ...
        print(f"  Full Path: ~/.ouro/memories/{db_name}/ (legacy: ~/.auto-claude/memories/)")
        print()
